...
export default function Layout({
   ...
   useEffect(() => {
      setAdminBody(document.querySelector('#therapist-body header') ?? null);
   }, [dispatch]);

   const options = [
      {
         name: 'Reservas activas',
         route: clinicRoutes(params.slug).therapist_appointments_actives,
      },
      {
         name: 'Historial de reservas',
         route: clinicRoutes(params.slug).therapist_appointments_history,
      },
   ];
