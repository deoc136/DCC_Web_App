...
export default function DetailsView({
   ...
   const { hide_for_receptionist } = useAppSelector(store => store.clinic);
   ...
   useEffect(() => {
      dispatch(
         changeTitle({
            goBackRoute: clinicRoutes(slug).receptionist_patients,
            ...
            <div className="grid h-max gap-10">
               ...
               <section className="flex justify-between">
                  ...
                  <Button
                     ...
                     href={
                        clinicRoutes(slug).receptionist_patients_id(user.id)
                           .details_history
                     }
                  >
